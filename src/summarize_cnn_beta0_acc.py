...
if __name__ == "__main__":
    ...
    print(
        "hidden1,hidden2,decoder_hidden,z_dim,lr,epochs,num_seeds,avg_final_test_acc,seeds"
    )
    for key in sorted(grouped):
        ...
        print(
            f"{hidden1},{hidden2},{decoder_hidden},{z_dim},{lr:g},{epochs},{len(values)},{avg_acc:.6f},{seeds}"
        )
